...
public class PeerInfoConfig {
    ...
    public void loadPeerInfoConfig(String peerInfoConfigFile) throws IOException { //TODO: Handle this
        BufferedReader bufferedReader = new BufferedReader(new FileReader(peerInfoConfigFile));
        String line = "";
